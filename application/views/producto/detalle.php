                ...
                <div class="col-lg-6">
                    <div class="image-gallery-sticky-wrapper">
                        ...
                        <div class="thumbnails-container" id="thumbnailsContainer">
                            ...
                            for ($i = 1; $i <= 5; $i++) {
                                $imagen_key = 'imagen' . $i;
                                if (!empty($producto->$imagen_key)) {
                                    $imagenes[] = $producto->$imagen_key;
                                }
                            }
                            ...
                            ?>
                                <div class="thumbnail-wrapper <?= $index === 0 ? 'active' : '' ?>" 
                                     onclick="changeMainImage('<?= base_url($imagen) ?>', this)">
                    ...
                    <div class="product-info-container">
                        ...
                        <?php if (!empty($producto->descripcion)): ?>
                            ...
                            <div class="product-description">
                                ...
                                $descripcion = preg_replace('/\s*\r?\n\s*/', ' ', $descripcion);
                                
                                // Limpiar espacios múltiples
                                $descripcion = preg_replace('/\s{2,}/', ' ', $descripcion);
                        ...
                        <?php else: ?>
                            <div class="product-description">
                                <em style="color: #a0aec0;">No hay descripción disponible para este producto.</em>
                            </div>
                        <?php endif; ?>
