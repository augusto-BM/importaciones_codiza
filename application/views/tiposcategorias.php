...
<script>
    const base_url = '<?php echo base_url(); ?>tipocategoria/';
</script>
<div class="dashboard-wrapper">
    <div class="dashboard-container">
        <div class="page-header">
            <h1><i class="fas fa-list"></i> Tipos de Categorías</h1>
            ...
            <table class="table table-striped table-bordered table-hover" id="tablaGeneral">
                <thead>
                    <tr>
                        ...
                        <td class="text-center" style="width:85%" data-orderable="false">NOMBRE</td>
